...
- Les données proviennent de l'endpoint de compte `https://api.anthropic.com/api/oauth/usage`, interrogé toutes les 2 minutes quand l'overlay est visible. Aucune consommation d'usage de modèle. En cas de réponse 429, le délai Retry-After est respecté avant tout nouvel essai.
